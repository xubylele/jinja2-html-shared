...
describe("resolveTemplatePath", () => {
  it("joins each root with the relative path in priority order", () => {
    const out = resolveTemplatePath("auth/login.html", null, [
      "/repo/app/templates",
  ...
  it("appends a relative-to-current-file fallback", () => {
    const out = resolveTemplatePath("partial.html", "/repo/app/templates/auth/login.html", [
      "/repo/app/templates",
    ]);
    expect(out).toEqual([
  ...
  it("deduplicates identical candidates", () => {
    const out = resolveTemplatePath("partial.html", "/r/partial.html", ["/r"]);
